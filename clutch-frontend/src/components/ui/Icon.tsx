...
const PATHS = {
  ...
  trophy: 'M8 21h8M12 17v4M5 4h14v4a7 7 0 01-14 0zM5 6H3v1a3 3 0 003 3M19 6h2v1a3 3 0 01-3 3',
...
export const Icon = ({ name, size = 20, strokeWidth = 1.9, className }: IconProps) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
